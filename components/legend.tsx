...
type LBDataWithColor = LBData & { color?: "blue" | "green" | string };

export function Legend(props: LegendProps) {
	const { updatedAt, data } = props;
	const totalBlue = data.filter((r) => (r as LBDataWithColor).color === "blue").length;
	const totalGreen = data.filter((r) => (r as LBDataWithColor).color === "green").length;
